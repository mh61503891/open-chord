/***************************************************************************
 * * ChordRetrievalFutureImpl.java * ------------------- * date : 15.10.2005 * copyright : (C) 2004-2008 Distributed and * Mobile Systems Group * Lehrstuhl fuer
...
class ChordRetrievalFutureImpl extends ChordFutureImpl implements ChordRetrievalFuture {
	...
	/**
	 * Factory method to create an instance of this class. This method also prepares execution of the retrieval with help of the provided {@link Executor}
	 * <code>exec</code>.
	 *
	 * @param exec
