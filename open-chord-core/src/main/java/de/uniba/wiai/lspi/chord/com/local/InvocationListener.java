/***************************************************************************
 * * InvocationListener.java * ------------------- * date : 06.10.2004, 13:42 * copyright : (C) 2004-2008 Distributed and * Mobile Systems Group * Lehrstuhl
 * fuer Praktische Informatik * Universitaet Bamberg * http://www.uni-bamberg.de/pi/ * email : sven.kaffille@uni-bamberg.de * karsten.loesing@uni-bamberg.de * *
 * *
 ***************************************************************************/
...
/**
 * This interface has to be implemented by classes that want to be notified about invocations made to a {@link ThreadEndpoint}.
 *
 * @author sven
 * @version 1.0.5
 */
