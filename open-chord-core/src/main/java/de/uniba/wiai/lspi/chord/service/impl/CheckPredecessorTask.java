/***************************************************************************
 * * CheckPredecessorTask.java * ------------------- * date : 16.08.2004 * copyright : (C) 2004-2008 Distributed and * Mobile Systems Group * Lehrstuhl fuer
		...
		try {
			...
			if (predecessor == null) {
				...
				try {
					...
					if (debug) {
						CheckPredecessorTask.logger.debug("Checking predecessor was NOT successful due " + "to a communication failure! Removing " + "predecessor reference.", e);
					}
