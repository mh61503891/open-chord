/***************************************************************************
 * * ChordREmoveFuture.java * ------------------- * date : 15.10.2005 * copyright : (C) 2004-2008 Distributed and * Mobile Systems Group * Lehrstuhl fuer
...
/**
 * Implementation of {@link ChordFuture} for removal of an entry from the chord distributed hash table.
 *
 * @author sven
 * @version 1.0.5
 */
class ChordRemoveFuture extends ChordFutureImpl {
	...
	/**
	 * Factory method to create an instance of this class. This method also prepares execution of the removal with help of the provided {@link Executor}
	 * <code>exec</code>.
	 *
	 * @param exec
	 *            The executor that should asynchronously execute the removal of <code>entry</code> with key <code>k</code>.
	 * @param c
	 *            The instance of {@link Chord} that should be used to remove <code>entry</code>.
	 * @param k
	 ...
	 */
	final static ChordRemoveFuture create(Executor exec, Chord c, Key k, Serializable entry) {
		if (c == null) {
