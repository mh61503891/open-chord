/***************************************************************************
 * * RemoteRefsAndEntries.java * ------------------- * date : 20.04.2005 * copyright : (C) 2004-2008 Distributed and * Mobile Systems Group * Lehrstuhl fuer
...
final class RemoteRefsAndEntries implements Serializable {
	 ...
	 * @param nodeInfos1
	 */
	protected RemoteRefsAndEntries(Set<Entry> entries1, List<RemoteNodeInfo> nodeInfos1) {
