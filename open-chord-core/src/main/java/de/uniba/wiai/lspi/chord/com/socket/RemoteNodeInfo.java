/***************************************************************************
 * * RemoteNodeInfo.java * ------------------- * date : 20.04.2005 * copyright : (C) 2004-2008 Distributed and * Mobile Systems Group * Lehrstuhl fuer
 ...
 ***************************************************************************/
/*
 * Created on 20.04.2005 TODO To change the template for this generated file go to Window - Preferences - Java - Code Style - Code Templates
 */
...
/**
 * This class represents information about a remote node that can be used to construct a {@link SocketProxy}. This class is sent over the network by
 * {@link SocketEndpoint endpoints} instead of sending complete {@link SocketProxy proxies}. The receiver has to construct {@link SocketProxy proxies} from the
