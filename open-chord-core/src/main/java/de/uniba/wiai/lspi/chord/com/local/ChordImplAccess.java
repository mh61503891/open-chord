/***************************************************************************
 * * ChordImplAccess.java * ------------------- * date : 13.12.2005 * copyright : (C) 2004-2008 Distributed and * Mobile Systems Group * Lehrstuhl fuer
...
public class ChordImplAccess {
	...
	/**
	 * Private constructor, so that no instances of this can be created by other classes.
	 */
	...
	private static void handleException(Exception e) {
		System.err.println("This should not happen! This indicates that " + "the implementation " + "of service layer has changed. " + "This code relies heavily on internal structure of service "
				+ "layer, as it was not possible to solve some problem " + "with local communication by other means!");
