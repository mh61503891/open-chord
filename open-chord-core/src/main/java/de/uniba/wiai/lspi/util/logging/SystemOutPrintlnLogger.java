/***************************************************************************
 * * SystemOutPrintlnLogger.java * ------------------- * date : 09.09.2004 * copyright : (C) 2004-2008 Distributed and * Mobile Systems Group * Lehrstuhl fuer
...
public class SystemOutPrintlnLogger extends Logger {
	...
	public void debug(Object msg) {
		System.out.println("DEBUG " + this.name + " " + ": " + msg);
	}

	/**
	 * Log a message object with the <code>DEBUG</code> level including the stack trace of the Throwable t passed as parameter.
	 *
	 * @param msg
	 *            The message object to log.
	 * @param t
	...
	/**
	 * Log a message object with the <code>INFO</code> level including the stack trace of the Throwable t passed as parameter.
	 *
	 * @param msg
	 *            The message object to log.
	 * @param t
	...
	public void warn(Object msg) {
		System.out.println("WARN  " + this.name + " " + ": " + msg);
	}

	/**
	 * Log a message object with the <code>WARN</code> level including the stack trace of the Throwable t passed as parameter.
	 *
	 * @param msg
	 *            The message object to log.
	 * @param t
	...
	public void error(Object msg) {
		System.out.println("ERROR " + this.name + " " + ": " + msg);
	}

	/**
	 * Log a message object with the <code>ERROR</code> level including the stack trace of the Throwable t passed as parameter.
	 *
	 * @param msg
	 *            The message object to log.
	 * @param t
	...
	public void fatal(Object msg) {
		System.out.println("FATAL " + this.name + " " + ": " + msg);
	}

	/**
	 * Log a message object with the <code>FATAL</code> level including the stack trace of the Throwable t passed as parameter.
	 *
	 * @param msg
	 *            The message object to log.
	 * @param t
