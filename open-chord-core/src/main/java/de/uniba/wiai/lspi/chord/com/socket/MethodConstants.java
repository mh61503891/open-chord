/***************************************************************************
 * * MethodConstants.java * ------------------- * date : 02.09.2004, 15:23 * copyright : (C) 2004-2008 Distributed and * Mobile Systems Group * Lehrstuhl fuer
...
/**
 * This class contains constants regarding methods that can be invoked on {@link de.uniba.wiai.lspi.chord.com.Node}. Do not forget that this class has to be
 * edited eventually if the methods in {@link de.uniba.wiai.lspi.chord.com.Node} change.
 * <p>
...
final class MethodConstants {
	...
	/**
	 * Integer constant used to notify the endpoint that a proxy is shutting down .
	 */
	static final int SHUTDOWN = 11;

	/**
	 * Array containing names of methods of {@link de.uniba.wiai.lspi.chord.com.Node}. A name of a method can be accessed by using the constant identifying the
	 * method as an index into this array.
	 */
	static final String[] METHOD_NAMES = new String[] { "findSuccessor", "getNodeID", "insertEntry", "insertReplicas", "leavesNetwork", "notify", "notifyAndCopyEntries", "ping", "removeEntry",
