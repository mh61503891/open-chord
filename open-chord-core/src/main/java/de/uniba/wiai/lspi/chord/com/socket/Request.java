/***************************************************************************
 * * Request.java * ------------------- * date : 02.09.2004, 13:48 * copyright : (C) 2004-2008 Distributed and * Mobile Systems Group * Lehrstuhl fuer
...
/**
 * <p>
 * This class represents a request for the invocation of a method on a {@link Chord node}. <code>Request</code>s are sent by a {@link SocketProxy} to the
 * {@link SocketEndpoint} of the node the {@link SocketProxy} represents.
 * </p>
 * <p>
 * Results of a method invocation are sent back to the {@link SocketProxy} by {@link SocketEndpoint} with help of a {@link Response} message. with help of
 * </p>
 *
 * @author sven
 * @version 1.0.5
...
final class Request extends Message {
	...
	/**
	 * The type of this request. One of the method identifiers from {@link MethodConstants}.
	 */
	private int type;
	...
	/**
	 * Identifier used to identify this request. This identifier must be the value of the {@link Response#getInReplyTo()} field of a {@link Response} send for
	 * this request.
	 */
	 ...
	 *
	 * @return The type of this request. One of the method identifiers from {@link MethodConstants}.
	 */
	int getRequestType() {
		return this.type;
	}
	 ...
	 *
	 * @return Identifier used to identify this request. This identifier must be the value of the {@link Response#getInReplyTo()} field of a {@link Response}
	 *         send for this request.
	 */
	String getReplyWith() {
