/***************************************************************************
 * * NodeImpl.java * ------------------- * date : 16.08.2004 * copyright : (C) 2004-2008 Distributed and * Mobile Systems Group * Lehrstuhl fuer Praktische
...
public final class NodeImpl extends Node {
	...
	/**
	 * Object logger. The name of the logger is the name of this class with the nodeID appended. The length of the nodeID depends on the number of bytes that
	 * are displayed when the ID is shown in Hex-Representation. See documentation of {@link ID}. E.g. de.uniba.wiai.lspi.chord.service.impl.NodeImpl.FF FF FF
	 * FF if the number of displayed Bytes of an ID is 4.
	 */
	...
	/**
	 * Creates that part of the local node which answers remote requests by other nodes. Sole constructor, is invoked by ChordImpl only.
	 *
	 * @param impl
	...
	/**
	 * Makes this endpoint accept entries by other nodes. Is invoked by ChordImpl only.
	 */
