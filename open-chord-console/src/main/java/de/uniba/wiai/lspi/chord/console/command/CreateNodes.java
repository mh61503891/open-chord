/***************************************************************************
 * * CreateNodes.java * ------------------- * date : 09.09.2004, 11:16 * copyright : (C) 2004-2008 Distributed and * Mobile Systems Group * Lehrstuhl fuer
 ...
 ***************************************************************************/
/*
 * CreateNodes.java Created on 9. September 2004, 11:16
 */
...
/**
 * Command to create a number of nodes. To get a description of this command type <code>create -help</code> into the
...
public class CreateNodes extends de.uniba.wiai.lspi.util.console.Command {
	...
	public void exec() throws ConsoleException {
		if (!this.parameters.containsKey(NAMES_PARAM)) {
			throw new ConsoleException("Not enough parameters. Provide at " + "least one node name with help of '" + NAMES_PARAM + "' parameter.");
		}
