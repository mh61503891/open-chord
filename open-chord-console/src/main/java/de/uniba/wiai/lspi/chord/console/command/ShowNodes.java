/***************************************************************************
 * * ShowNodes.java * ------------------- * date : 09.09.2004, 18:12 * copyright : (C) 2004-2008 Distributed and * Mobile Systems Group * Lehrstuhl fuer
 ...
 * </p>
 * To get a description of this command type <code>showNodes -help</code> into the {@link de.uniba.wiai.lspi.chord.console.Main console}.
 *
 * @author sven
 * @version 1.0.5
 */
public class ShowNodes extends Command {
	...
	public void printOutHelp() {
		this.out.println("The " + COMMAND_NAME + " command prints out a list of all " + "nodes currently present in this JVM.");
		this.out.println("The nodes are listed in the same order, in that they are arranged " + "on the chord ring.");
		this.out.println("If you want to know the number of nodes currently " + "running just provide '" + COUNT_PARAM + "' parameter.");
	}
